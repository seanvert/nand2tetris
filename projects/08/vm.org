...
* ⚑ ESPERANDO arguments
- falta colocar um jeito de lidar com pastas
- também precisa mudar a ordem pra ficar melhor com o final

OS.Path.fromString "/home/sean/nand2tetris/vm.asd";

OS.FileSys.readDir (OS.FileSys.openDir ".");

val dirstream = OS.FileSys.openDir "/home/sean/nand2tetris/projects/08/FunctionCalls/SimpleFunction/";
