...
#+RESULTS:
: stdIn:190.7-190.32 Warning: binding not exhaustive
:           SOME i = ...
...
#+RESULTS:
: stdIn:212.7-212.39 Warning: binding not exhaustive
:           SOME args = ...
: stdIn:211.7-211.46 Warning: binding not exhaustive
:           SOME fname = ...
...
#+RESULTS:
: stdIn:455.29-455.45 Error: unbound variable or constructor: writeFunctionOps
