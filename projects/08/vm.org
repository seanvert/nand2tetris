...
#+RESULTS:
: stdIn:1263.5-1266.25 Warning: match nonexhaustive
:           p :: ph => ...
:   
: 
...
#+RESULTS:
: stdIn:1331.7-1331.32 Warning: binding not exhaustive
:           SOME i = ...
...
#+RESULTS:
: stdIn:1621.7-1621.39 Warning: binding not exhaustive
:           SOME args = ...
: stdIn:1620.7-1620.46 Warning: binding not exhaustive
:           SOME fname = ...
...
#+RESULTS:
: stdIn:1636.16-1638.51 Warning: match nonexhaustive
:           SOME Return => ...
:           NONE => ...
:   
...
#+RESULTS:
: val writeFunctionOps = fn : 'a -> string
...
#+RESULTS:
: stdIn:1589.9-1589.17 Error: unbound variable or constructor: filename
: stdIn:1585.9-1585.17 Error: unbound variable or constructor: filename
: stdIn:1583.9-1583.17 Error: unbound variable or constructor: filename
: stdIn:1579.9-1579.17 Error: unbound variable or constructor: filename
: stdIn:1577.9-1577.17 Error: unbound variable or constructor: filename
...
#+RESULTS:
: stdIn:1607.18-1607.31 Error: unbound variable or constructor: writeLogArith
