...
#+RESULTS:
: stdIn:1703.5-1706.25 Warning: match nonexhaustive
:           p :: ph => ...
:   
: 
...
#+RESULTS:
: stdIn:1771.7-1771.32 Warning: binding not exhaustive
:           SOME i = ...
...
#+RESULTS:
: stdIn:1793.7-1793.39 Warning: binding not exhaustive
:           SOME args = ...
: stdIn:1792.7-1792.46 Warning: binding not exhaustive
:           SOME fname = ...
...
#+RESULTS:
: stdIn:1808.16-1810.51 Warning: match nonexhaustive
:           SOME Return => ...
:           NONE => ...
:   
...
** ⚑ ESPERANDO write function operations
- escrever o assembly
- separar os cases
#+begin_src sml
...
#+RESULTS:
: stdIn:1973.9-1973.17 Error: unbound variable or constructor: filename
: stdIn:1969.9-1969.17 Error: unbound variable or constructor: filename
: stdIn:1967.9-1967.17 Error: unbound variable or constructor: filename
: stdIn:1963.9-1963.17 Error: unbound variable or constructor: filename
: stdIn:1961.9-1961.17 Error: unbound variable or constructor: filename
...
#+RESULTS:
: stdIn:1991.18-1991.31 Error: unbound variable or constructor: writeLogArith
...
#+RESULTS:
: stdIn:2011.45-2011.61 Error: unbound variable or constructor: getLineWriteCode
...
#+RESULTS:
: stdIn:2002.21-2002.25 Error: unbound variable or constructor: args
: stdIn:2018.9-2018.17 Error: unbound variable or constructor: readfile
